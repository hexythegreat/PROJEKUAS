    ...
    <div class="container">
        <div class="row">
            <div class="categories__slider owl-carousel">
                ...
                ?>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/<?= $cat[$i % count($cat)] ?>">
                            <h5><a href="product.php"><?= $row['name'] ?></a></h5>
                        </div>
                    </div>
                <?php $i++;
                } ?>
                ...
                <div class="latest-product__text">
                    ...
                    <div class="latest-product__slider owl-carousel">
                        <div class="latest-prdouct__slider__item">
                            ...
                            $i = 0;
                            foreach ($result as $key => $value) { ?>
                                <a href="detail.php?sku=<?= $value['sku'] ?>" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="img/product/<?= $img[$i % 3] ?>" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6><?= $value['name'] ?></h6>
                                        <span>Rp.<?= number_format($value['sell_price'], 0, ',', '.'); ?></span>
                                    </div>
                                </a>
                            <?php $i++;
                            } ?>
                        ...
                        <div class="latest-prdouct__slider__item">
                            ...
                            <?php
                            shuffle($img);
                            $sql = "SELECT * FROM product ORDER BY id DESC LIMIT 3 OFFSET 2";
                            $smt = $dbh->prepare($sql);
                            $smt->execute();
                            $result = $smt->fetchAll(PDO::FETCH_ASSOC);
                            $i = 0;
